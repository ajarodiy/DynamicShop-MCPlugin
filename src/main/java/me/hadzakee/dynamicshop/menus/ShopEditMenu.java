...
public class ShopEditMenu extends Menu {
    ...
    public void setMenuItems() {
        ...
        ShopItemsList.getItemsOnPage(page).forEach(item -> {
            ...
            lore.add(ColorTranslator.translateColorCodes(" &#24e331➯ &#2ff53c&lCurrent Sell Price: &#2ca5f5$" + item.getCurrentSellPrice()));
            lore.add(ColorTranslator.translateColorCodes(" &#24e331➯ &#2ff53c&lActual  Sell Price:  &#2ca5f5$" + item.getSellPrice()));
            lore.add("");
            lore.add(ColorTranslator.translateColorCodes(" &#24e331➯ &#2ff53c&lCurrent Buy Price: &#2ca5f5$" + item.getCurrentBuyPrice()));
            lore.add(ColorTranslator.translateColorCodes(" &#24e331➯ &#2ff53c&lActual  Buy Price:  &#2ca5f5$" + item.getBuyPrice()));
            lore.add("");
